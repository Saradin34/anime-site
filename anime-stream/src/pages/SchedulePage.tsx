...
export default function SchedulePage() {
  useSeo({
    title: 'Расписание выхода новых серий аниме',
    description: 'Календарь выхода серий аниме-онгоингов 2026: точные дни недели и время. Не пропустите новый эпизод любимого сериала. Полное расписание аниме на неделю на AnimeFlux.',
    canonical: '/schedule',
    keywords: 'расписание аниме, календарь аниме, выход серий аниме, когда выходит аниме, аниме онгоинги 2026, следующая серия, график аниме',
    breadcrumbs: [
      { name: 'Главная', url: '/' },
